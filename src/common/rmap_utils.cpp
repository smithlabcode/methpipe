...
rmap::split(std::string s, const char *delim, bool get_empty_fields) {
...
void
rmap::split_whitespace(const std::string& s, std::vector<std::string> &v) {
...
std::vector<std::string>
rmap::split_whitespace_quoted(std::string to_split) {
  static const char *non_word_chars = " \t\"'";
  to_split = rmap::strip(to_split);
...
double
rmap::log_sum_log_vec(const std::vector<double> &vals, size_t limit) {
