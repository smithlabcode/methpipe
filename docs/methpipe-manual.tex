...
boundary estimate based on the coverage of the sample. For boundaries with
a not-a-number (-nan) boundary likelihood, it is because all CpGs on one
side of the boundary or the other have zero coverage, and therefore no
confidence score could be assigned to the boundary. The fifth column is 
